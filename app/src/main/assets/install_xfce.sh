...
apk update || error
apk add --no-cache ca-certificates curl openssl xvfb x11vnc xfce4 xfce4-terminal faenza-icon-theme dbus-x11 || error
...
pkill Xvfb
pkill pulse
for i in \$(pidof startxfce4; pidof xfce4-session; pidof xfconfd; pidof xfce4-panel; pidof xfce4-power-manager); do
    kill \$i;
